...
////  Library Booking
////
////  Created by Divya Arora on 25/02/25.
////
//
//
//import SwiftUI
...
//    @Environment(\.dismiss) var dismiss // Dismiss the current view to go back
...
//                                .padding()
//
//                            Text("Location: \(selectedLibrary.location)")
//                                .font(.subheadline)
//                                .foregroundColor(.gray)
//                                .padding(.bottom)
//
//                            Image(selectedLibrary.imageName)
//                                .resizable()
//                                .scaledToFit()
//                                .frame(height: 200)
//                                .cornerRadius(12)
...
//                                        Text(library.name)
//                                            .font(.headline)
//                                            .foregroundColor(selectedLibrary?.name == library.name ? .blue : .primary)
...
//                                .padding(.vertical, 8)
//                                .padding(.horizontal)
//                                .background(selectedLibrary?.name == library.name ? Color.blue.opacity(0.1) : Color.clear)
//                                .cornerRadius(10)
...
//                                // Dismiss the current view and go back to the previous screen
...
//                            .transition(.scale)
//                    }
//                    .animation(.easeInOut, value: isBookingConfirmed)
//                }
//            }
//        }
//    }
...
//   
//
//    func fetchLibrariesForBook(isbn: String, completion: @escaping ([Library]) -> Void) {
//        let db = Firestore.firestore()
//        var libraries: [Library] = []
//        
//        // Step 1: Fetch all books with the given ISBN
//        db.collection("books")
...
//                
//                // Step 2: Fetch library details for each libraryId
...
//                        }
//
//                        if let libraryData = librarySnapshot?.data() {
//                            if let name = libraryData["name"] as? String,
//                               let location = libraryData["city"] as? String {
//                                let library = Library(id: libraryId, name: name, location: location)
...
//                }
//                
//                // Step 3: Return the list of libraries once all queries are complete
